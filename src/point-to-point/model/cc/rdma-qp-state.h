 ...
 */
#ifndef RDMA_SOCKET_STATE_H
#define RDMA_SOCKET_STATE_H

#include "rdma-rx-buffer.h"
 ...
 *
 */
class RdmaSocketState : public Object
{
  public:
    /**
     * Get the type ID.
    ...
    /**
     * @brief RdmaSocketState Constructor
     */
    RdmaSocketState()
        : Object()
    {
     ...
     */
    RdmaSocketState(const RdmaSocketState& other);
     ...
     *        similar to sysctl for Rdma_ecn. Currently value 2 from
     ...
     */
    INTERNET_EXPORT static const char* const RdmaCongStateName[RdmaSocketState::CA_LAST_STATE];

    /**
     * @brief Literal names of ECN states for use in log messages
     */
    INTERNET_EXPORT static const char* const EcnStateName[RdmaSocketState::ECN_CWR_SENT + 1];
    ...
    TracedValue<RdmaCongState_t> m_congState{CA_OPEN}; //!< State in the Congestion state machine
...
/**
 * @ingroup Rdma
 * TracedValue Callback signature for RdmaCongState_t
 *
 * @param [in] oldValue original value of the traced variable
 * @param [in] newValue new value of the traced variable
 */
typedef void (*RdmaCongState)(const RdmaSocketState::RdmaCongState_t oldValue,
                             const RdmaSocketState::RdmaCongState_t newValue);
 ...
 * @param [in] newValue new value of the traced variable
 */
typedef void (*EcnState)(const RdmaSocketState::EcnState_t oldValue,
                         const RdmaSocketState::EcnState_t newValue);

} // namespace TracedValueCallback

} // namespace ns3

#endif /* Rdma_SOCKET_STATE_H */
