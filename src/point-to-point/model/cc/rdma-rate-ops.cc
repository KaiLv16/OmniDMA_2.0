...
NS_LOG_COMPONENT_DEFINE("RdmaRateOps");
NS_OBJECT_ENSURE_REGISTERED(RdmaRateOps);

TypeId
RdmaRateOps::GetTypeId()
{
    static TypeId tid = TypeId("ns3::RdmaRateOps").SetParent<Object>().SetGroupName("Internet");
    return tid;
}

NS_OBJECT_ENSURE_REGISTERED(RdmaRateLinux);

TypeId
RdmaRateLinux::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::RdmaRateLinux")
            .SetParent<RdmaRateOps>()
            .SetGroupName("Internet")
            .AddTraceSource("RdmaRateUpdated",
                            "Rdma rate information has been updated",
                            MakeTraceSourceAccessor(&RdmaRateLinux::m_rateTrace),
                            "ns3::RdmaRateLinux::RdmaRateUpdated")
            .AddTraceSource("RdmaRateSampleUpdated",
                            "Rdma rate sample has been updated",
                            MakeTraceSourceAccessor(&RdmaRateLinux::m_rateSampleTrace),
                            "ns3::RdmaRateLinux::RdmaRateSampleUpdated");
    return tid;
}

const RdmaRateOps::RdmaRateSample&
RdmaRateLinux::GenerateSample(uint32_t delivered,
                             uint32_t lost,
                             bool is_sack_reneg,
...
void
RdmaRateLinux::CalculateAppLimited(uint32_t cWnd,
                                  uint32_t in_flight,
...
void
RdmaRateLinux::SkbDelivered(RdmaTxItem* skb)
{
    NS_LOG_FUNCTION(this << skb);

    RdmaTxItem::RateInformation& skbInfo = skb->GetRateInformation();
...
void
RdmaRateLinux::SkbSent(RdmaTxItem* skb, bool isStartOfTransmission)
{
...
std::ostream&
operator<<(std::ostream& os, const RdmaRateOps::RdmaRateConnection& rate)
{
...
std::ostream&
operator<<(std::ostream& os, const RdmaRateOps::RdmaRateSample& sample)
{
